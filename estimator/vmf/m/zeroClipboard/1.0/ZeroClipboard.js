 ...
 */(function() {
  ...
  // new method to change copy to copied on click
  var _changeCopy = function(element, lblCopy){      
      var curElement = element.getAttribute("id");
      $('#'+curElement).html(lblCopy);
  };  
  ...
  var _defaults = {
    moviePath: "/vmf/m/zeroClipboard/ZeroClipboard.swf",
    trustedDomains: null,
    text: null,
  ...
  ZeroClipboard.prototype.receiveEvent = function(eventName, args) {
    ...
    switch (eventName) {
     ...
     case "mousedown":
      ...
      // use extened _changeCopy method to change button text from copy to copied
      _changeCopy(element, this.options.labelCopy);
      break;
     case "mouseup":
...
vmf.zeroClipboardShow = function($){
   return{
       init:function(id, lblCopied){
           var clip = new ZeroClipboard($(id), {
            moviePath: "/vmf/m/zeroClipboard/1.0/ZeroClipboard.swf",
            labelCopy :lblCopied
        });
       }
   } 
