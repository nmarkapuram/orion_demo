...
(function($) {
    ...
    function showTooltip(plot, series, neighbor) {
        ...
        var borderStr = eleHeight/2 + 'px';
        var leftShift = 0;
        
        if(positionFlag == 0){
            $elem.find('span.emptyArrow').css({
                'border-right': borderStr + ' solid #DDD',
                'border-top': borderStr + ' solid transparent',
                'border-bottom': borderStr + ' solid transparent'
            });
            leftShift = eleHeight/2;
        } else {
            $elem.find('span.emptyArrow').css({
                'left' : '100%',
                'border-left': borderStr + ' solid #DDD',
                'border-top': borderStr + ' solid transparent',
                'border-bottom': borderStr + ' solid transparent'
            });
            leftShift = -(eleHeight/2);
